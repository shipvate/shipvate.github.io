...
document.addEventListener('DOMContentLoaded', function() {
  const btnMobile = document.getElementById('boostBtnMobile');
  const btnDesktop = document.getElementById('boostBtn');
  if (btnMobile && btnDesktop) {
    btnMobile.addEventListener('touchstart', function(e) {
      e.preventDefault();
      btnDesktop.dispatchEvent(new Event('mousedown'));
    }, { passive: false });
    btnMobile.addEventListener('touchend', function(e) {
      e.preventDefault();
      btnDesktop.dispatchEvent(new Event('mouseup'));
    });
    btnMobile.addEventListener('touchcancel', function(e) {
      e.preventDefault();
      btnDesktop.dispatchEvent(new Event('mouseup'));
    });
